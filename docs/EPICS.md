...
| GMV-4 | Foundry v13 compatibility (verification) | `module.json#compatibility.maximum` bumped to v13 in 0.3.0; runtime verification in a real v13 world still pending (`verified` stays at `"12"` until a GM walks `docs/integration-test.md` against v13). GMHUB-162. |
